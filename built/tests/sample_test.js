...
gondola_1.TestModule("WebDriver sample tests");
...
*/
gondola_1.TestCase("Testcase 01: Check Cart items displayed correctly", async () => {
...
*/
gondola_1.TestCase("Testcase 02: Check Payment button is enabled when user inputs valid information.", async () => {
    await homePage_1.default.navigateTo();
    await homePage_1.default.selectWomenTab();
    await productPage_1.default.addToCart(firstProduct);
    await productPage_1.default.addToCart(secondProduct, cartCount);
