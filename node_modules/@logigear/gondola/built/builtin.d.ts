...
export interface IGondolaWeb {
     ...
     * ```
     * @Note This action is not supported when using the iOS version of Safari.
     */
...
export interface IGondolaMobile {
     ...
     * ```typescript
     * // Presses a key on Android
     * gondola.hideDeviceKeyboard('pressKey', 'Done');
     *
     * // Presses a key on IOS
     * gondola.hideDeviceKeyboard('pressKey', 'default');
     * // Reference: https://developer.apple.com/documentation/uikit/uireturnkeytype.
     * ```
     * @experimental v1
     * &#62; Can be changed or removed soon
     */
     ...
     * ```
     */
    executeCommand(command: string, args?: (string | object | number | boolean | undefined)[]): Promise<any>;
    /**
     ...
     * ```
     */
    setPickerValue(element: string | ILocator, value: string | (string | undefined)[]): Promise<void>;
}
/**
